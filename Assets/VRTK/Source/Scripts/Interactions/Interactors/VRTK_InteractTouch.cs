        ...
        protected virtual void CreateTouchCollider()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    controllerCollisionDetector.transform.SetParent(transform);
                    controllerCollisionDetector.transform.localScale = transform.localScale;
                    controllerCollisionDetector.transform.localScale = new Vector3(controllerCollisionDetector.transform.localScale.x*0.05f, 
                                                                                   controllerCollisionDetector.transform.localScale.y*0.05f/2f, 
                                                                                   controllerCollisionDetector.transform.localScale.z*0.05f);
                    controllerCollisionDetector.transform.localPosition = new Vector3(0, -0.0581f, 0.0421f);
                    controllerCollisionDetector.transform.Rotate(47.832f,0,0);
                    destroyColliderOnDisable = true;
                }
            }
